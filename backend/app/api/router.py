...
from app.api import agents, audits, auth, knowledge, llms, monitor, quality, runs, sessions, skills, test_cases, tools, uploads, workspace
...
api_router.include_router(workspace.router, dependencies=secured_dependencies)
